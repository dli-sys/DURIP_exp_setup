...
const int minDegrees = 0;   // Minimum servo angle
const int maxDegrees = 180; // Maximum servo angle
const int sweepDelay = 15;  // Delay between servo movements (in milliseconds)
